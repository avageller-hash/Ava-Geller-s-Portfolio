...
import { MOVIE_TRAILER_THUMBNAIL } from './components/MovieTrailerWindow';
 ...
 */
export const PAIR_OF_ACES_VIDEO_URL = "https://i.imgur.com/9PY5s2x.mp4";
...
export const DESKTOP_ICONS: DesktopIconData[] = [
  ...
  { id: 'projekty', title: 'UGC & Video Content Portfolio', iconSrc: '', x: 61, y: 44, type: 'folder' },
  { id: 'movie-trailer', title: "I made a trailer for a movie that doesn't exist yet.", iconSrc: 'https://i.imgur.com/tV0k98O.png', x: 83, y: 45, orientation: 'horizontal', type: 'file' },
